...
cases:
  ...
  # baseline_share is 0.49 here, under Gate A's 0.5: his recent window is the single week-1 game
  # (49%), which beats his 0.564 mean across 2022. A position-blind floor is wrong for backs.
  - {id: chubb_2023_w2,      player: "Nick Chubb",         season: 2023, week: 2,  team: CLE, unit: offense, snaps_unit: 18, share: 0.21, expect_exit: true, baseline_share_below_half: true, fact: "knee, Q2 at PIT (MNF); IR"}
  ...
  # CORRECTED 2026-09-08 against the data. He did NOT play the wild-card game: Ryan Jensen missed
  # all 17 regular-season games injured, returned for the playoffs and reclaimed the job. Hainsey
  # is a KNOWN FALSE POSITIVE for the shipped early_exit composite. See tests/fixtures/exits.yaml,
  # which is the authority; this block is a copy for a session starting from scratch.
  - {id: hainsey_2022_w18,   player: "Robert Hainsey",    season: 2022, week: 18, team: TB, unit: offense, snaps_unit: 13, share: 0.24, expect_exit: false, expect_played_next: false, fact: "rested, division clinched; did not play the wild-card game because Ryan Jensen returned from injury and reclaimed the starting centre job"}
